...
export const datePickerProps = buildProps({
  ...
  labels: Object as PropType<Partial<Record<DateUnitType, string>>>,
  ...
  onInput: eventProp<(type: DateUnitType, value: number) => void>(),
  onPlus: eventProp<(type: DateUnitType, value: number) => void>(),
  onMinus: eventProp<(type: DateUnitType, value: number) => void>(),
  onEnter: eventProp(),
  onCancel: eventProp(),
  ...
  onFocus: eventProp(),
  onBlur: eventProp(),
  onChangeCol: eventProp<(type: DateUnitType | null, inputType: 'start' | 'end') => void>(),
