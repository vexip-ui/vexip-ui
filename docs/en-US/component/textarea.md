...
| autocomplete   | `boolean \| string`                              | Set autocomplete for textarea, the boolean value will be parsed to `'on'` or `'off'`                                       | `false`              | -        |
...
| hide-count     | `boolean`                                        | Set whether to hide the word count content                                                                                 | `false`              | `2.3.33` |
