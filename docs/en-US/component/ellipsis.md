...
| tip-delay       | `number \| number[]` | Set the delay for showing and hiding the tooltip, passing a number controls both, passing an array controls show and hide respectively           | `null`       | `2.3.40` |
