...
| row-dbclick      | Emitter when a row is dbclicked, returns row data, row index and row position index                                                  | `(payload: TableRowPayload)`                                                            | `2.0.1` |
...
| cell-dbclick     | Triggered when a cell is double clicked, returns row data, row index, row position index, column data and column index               | `(payload: TableCellPayload)`                                                           | `2.0.1` |
...
| head-dbclick     | Triggered when the head cell is double clicked, returns column data and column index                                                 | `(payload: TableHeadPayload)`                                                           | `2.0.1` |
