<template>
  <ConfigProvider :props="providedProps">
    <Form :model="formModel" style="max-width: 500px">
      ...
      <FormItem label="Select" prop="select" default-value="选项2">
      ...
      <FormItem label="Checkbox" prop="checkbox" :default-value="['选项3']">
        <CheckboxGroup :options="options"></CheckboxGroup>
      </FormItem>
      <FormItem label="Radio" prop="radio" default-value="选项3">
      ...
      <FormItem label="Transfer" prop="transfer" :default-value="['选项1']">
        <Transfer :options="options"></Transfer>
      </FormItem>
      <FormItem label="Wheel" prop="wheel" default-value="选项2">
